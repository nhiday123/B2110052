...
if (isset($_COOKIE[$cookie_name])) {
    // Nếu cookie tên người dùng đã được thiết lập, hiển thị tên người dùng và liên kết để đăng xuất
    echo '<li class="nav-item">';
    echo '<span class="nav-link"> ' . $_COOKIE[$cookie_name] . '</span>';
    echo '</li>';
    echo '<li class="nav-item">';
    echo '<a class="nav-link" href="logout.php">Đăng Xuất</a>';
    echo '</li>';
} elseif (isset($_GET['logged_out']) && $_GET['logged_out'] == true) {
    // Nếu người dùng đã đăng xuất, không hiển thị gì cả
} else {
    // Nếu cookie tên người dùng chưa được thiết lập, hiển thị liên kết để đăng nhập
    echo '<li class="nav-item">';
